"""Vendored verbatim from longliangLiu/PriOr-Flow (ICCV 2025), file ``core/corr.py``.
...
without checking with the authors. sha256 of the original: 2dfec59cee7ae989
"""
import torch
import torch.nn as nn
import torch.nn.functional as F
from .utils.utils import bilinear_sampler, coords_grid, cycle_bilinear_sampler
