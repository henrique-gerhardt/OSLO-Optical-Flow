"""Vendored verbatim from longliangLiu/PriOr-Flow (ICCV 2025), file ``core/extractor.py``.
...
without checking with the authors. sha256 of the original: 49dca49ad9df9ee5
"""
import torch
