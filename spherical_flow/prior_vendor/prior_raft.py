"""Vendored verbatim from longliangLiu/PriOr-Flow (ICCV 2025), file ``core/prior_raft.py``.
...
without checking with the authors. sha256 of the original: 94191a7d3478aa46
"""
import numpy as np
import torch
...
from .corr import DCCL
from .utils.utils import bilinear_sampler, coords_grid, upflow8, downflow8, cycle_bilinear_sampler
from .utils import projection_prim_ortho
